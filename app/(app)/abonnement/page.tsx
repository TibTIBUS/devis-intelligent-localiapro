  ...
  return (
    <main className="min-h-svh bg-[#F5F1E8] px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
      <section className="mx-auto w-full max-w-6xl space-y-7">
        ...
        <p className="text-center text-xs leading-5 text-muted-foreground">Les prix sont affichés hors taxes. Les taxes applicables sont calculées automatiquement par Stripe au moment du paiement. L’abonnement peut être géré depuis le portail client sécurisé Stripe.</p>
      </section>
    </main>
  );
}
