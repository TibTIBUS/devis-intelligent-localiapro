  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <section className="grid grid-cols-2 gap-2.5 sm:gap-3 xl:grid-cols-4" aria-label="Résumé du catalogue">
        <div className="rounded-xl border border-border bg-card p-3 shadow-sm sm:p-4"><div className="flex items-center gap-2.5 sm:gap-3"><span className="grid size-9 shrink-0 place-items-center rounded-xl bg-blue-50 text-blue-600 sm:size-10"><Folder className="size-4 sm:size-5" /></span><div className="min-w-0"><p className="text-[11px] text-muted-foreground sm:text-xs">Catégories</p><p className="text-xl font-semibold sm:text-2xl">{categories.length}</p></div></div></div>
        <div className="rounded-xl border border-border bg-card p-3 shadow-sm sm:p-4"><div className="flex items-center gap-2.5 sm:gap-3"><span className="grid size-9 shrink-0 place-items-center rounded-xl bg-emerald-50 text-emerald-600 sm:size-10"><Tag className="size-4 sm:size-5" /></span><div className="min-w-0"><p className="text-[11px] text-muted-foreground sm:text-xs">Prestations</p><p className="text-xl font-semibold sm:text-2xl">{items.length}</p></div></div></div>
        <div className="rounded-xl border border-border bg-card p-3 shadow-sm sm:p-4"><div className="flex items-center gap-2.5 sm:gap-3"><span className="grid size-9 shrink-0 place-items-center rounded-xl bg-violet-50 text-violet-600 sm:size-10"><Tag className="size-4 sm:size-5" /></span><div className="min-w-0"><p className="text-[11px] text-muted-foreground sm:text-xs">Prix moyen HT</p><p className="truncate text-base font-semibold sm:text-xl">{formatAveragePrice(items)}</p></div></div></div>
        <div className="rounded-xl border border-border bg-card p-3 shadow-sm sm:p-4"><div className="flex items-center gap-2.5 sm:gap-3"><span className="grid size-9 shrink-0 place-items-center rounded-xl bg-amber-50 text-amber-600 sm:size-10"><BarChart3 className="size-4 sm:size-5" /></span><div className="min-w-0"><p className="text-[11px] text-muted-foreground sm:text-xs">Valeur catalogue</p><p className="truncate text-base font-semibold sm:text-xl">{formatCatalogValue(items)}</p></div></div></div>
      </section>
